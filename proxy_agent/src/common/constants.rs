...
pub const AZURE_PROXY_AGENT_ENV_CONFIG_FULL_PATH: &str = "AZURE_PROXY_AGENT_ENV_CONFIG_FULL_PATH";
pub const AZURE_PROXY_AGENT_ENV_EBPF_FULL_PATH: &str = "AZURE_PROXY_AGENT_ENV_EBPF_FULL_PATH";
