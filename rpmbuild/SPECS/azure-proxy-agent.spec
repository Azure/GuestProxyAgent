# Generated by rust2rpm 27 and manual updated for service install and local build
...
### Those are only for offline builds using system crates, not for vendor builds
...
%install
# customized install the files for azure-proxy-agent service
