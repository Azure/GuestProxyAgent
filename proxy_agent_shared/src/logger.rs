...
const TOKIO_RUNTIME_SCHEDULER: &str = "tokio::runtime::scheduler"; // The runtime scheduler function that runs the tasks, found in command `cargo llvm-cov --target x86_64-unknown-linux-musl` with rust-1.88.0
